...
`/business-model` — dựng KPI tree, chọn bộ chỉ số ưu tiên và viết thẻ chỉ số.
...
Chạy `git pull`, mở **thư mục gốc** repo trong VSCode. Cần có sẵn business question từ buổi 3 và
Data Dictionary hoàn chỉnh từ buổi 4.

Các bước chi tiết nằm trong tài liệu LAB buổi 5 do giảng viên phát.
